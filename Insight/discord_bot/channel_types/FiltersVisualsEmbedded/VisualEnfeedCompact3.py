...
class VisualEnfeedCompact3(visual_enfeed):
    def make_header(self):
        ...
        e_desc = '**[{vP}]({vP_l})({vAfi})** to **[{fbP}]({fbP_l})({fbAfi})** {inv_str}.' \
            .format(vP=self.vi.str_pilot_name(), vP_l=self.vi.str_pilot_zk(), vAfi=self.vi.str_highest_name(),
                    ...
                    fbAfi=self.fb.str_highest_name(), inv_str=self.km.str_attacker_count())
