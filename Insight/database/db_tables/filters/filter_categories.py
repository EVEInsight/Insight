...
from ..eve import categories


class Filter_categories(dec_Base.Base, filter_base):
    ...
    object_channel = relationship("Channels", uselist=False, back_populates="object_filter_categories")
    ...
    def load_fk_objects(self):
        ...
        self.object_item = categories.Categories(self.filter_id) if self.filter_id else None
