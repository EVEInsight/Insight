...
class BL_alliances(dec_Base.Base,filter_base):
    __tablename__ = 'bl_alliances'
    ...
    object_channel = relationship("Channels",uselist=False,back_populates="object_bl_alliances")
