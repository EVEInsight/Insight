...
class BL_corporations(dec_Base.Base, filter_base):
    __tablename__ = 'bl_corporations'
    ...
    object_channel = relationship("Channels", uselist=False, back_populates="object_bl_corporations")
    object_item = relationship("Corporations", uselist=False, lazy="joined")
