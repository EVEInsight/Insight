...
from ..eve import types


class Filter_types(dec_Base.Base,filter_base):
    ...
    filter_id = Column(Integer, ForeignKey("types.type_id"),primary_key=True, nullable=False,autoincrement=False)
    ...
    object_channel = relationship("Channels",uselist=False,back_populates="object_filter_types")
    object_item = relationship("Types",uselist=False,lazy="joined")
    ...
    def load_fk_objects(self):
        ...
        self.object_item = types.Types(self.filter_id) if self.filter_id else None