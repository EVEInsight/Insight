...
class BL_characters(dec_Base.Base, filter_base):
    __tablename__ = 'bl_characters'
    ...
    object_channel = relationship("Channels", uselist=False, back_populates="object_bl_characters")
