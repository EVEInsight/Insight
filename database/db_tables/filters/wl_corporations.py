...
class WL_corporations(dec_Base.Base, filter_base):
    __tablename__ = 'wl_corporations'
    ...
    object_channel = relationship("Channels", uselist=False, back_populates="object_wl_corporations")
