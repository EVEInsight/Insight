...
class BL_categories(dec_Base.Base, filter_base):
    __tablename__ = 'bl_categories'
    ...
    object_channel = relationship("Channels", uselist=False, back_populates="object_bl_categories")
