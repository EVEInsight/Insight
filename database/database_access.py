...
class fa_systems(object):
    ...
    def __init__(self, con,skip_api = False):
        self.con_ = con
        self.db_systems = db_systems(con, skip_api)  # database instance
        self.system_list = []
...
class cap_info(object):
    ...
    def make_range_dict(self):
        return{"Titans": {"JDC4": self.config["eve_settings"]["titan_range_4"],
                          "JDC5": self.config["eve_settings"]["titan_range_5"]},
               "Supercarriers": {"JDC4": self.config["eve_settings"]["super_range_4"],
                                 "JDC5": self.config["eve_settings"]["super_range_5"]},
               "Carriers": {"JDC4": self.config["eve_settings"]["carrier_range_4"],
                            "JDC5": self.config["eve_settings"]["carrier_range_5"]},
               "Dreads": {"JDC4": self.config["eve_settings"]["dread_range_4"],
                          "JDC5": self.config["eve_settings"]["dread_range_5"]},
               "JumpFreighters": {"JDC4": self.config["eve_settings"]["jf_range_4"],
                          "JDC5": self.config["eve_settings"]["jf_range_5"]},
               "Blops": {"JDC4": self.config["eve_settings"]["blops_range_4"],
                                  "JDC5": self.config["eve_settings"]["blops_range_5"]}
               }
